...
SEED_FOODS = [
    ...
    ("сир кисломолочний 0.2%", 0, 72, 16.5, 0.2, 1.8, 0, 1.8, 0.1, 40, ["сир 0.2%", "творог 0.2%"]),
    ("лаваш вірменський", 0, 277, 9.1, 1.2, 56, 2.2, 1.5, 0.2, 500, ["лаваш"]),
    ("молоко 1%", 0, 42, 3.4, 1, 4.8, 0, 4.8, 0.6, 44, ["молоко"]),
    ("сир твердий", 0, 350, 25, 27, 1.5, 0, 0.5, 17, 650, ["твердий сир"]),
